            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/client.SignalLinkUrl"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/link/await": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Device Link URI",
                        "name": "device_link_uri",
                        "in": "query",
                        "required": true
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/client.SignalLinkNumber"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/link/qrcode": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "QR coede version. Defaults to 10",
                        "name": "qrcode_version",
                        "in": "query"
                    }
                ],
